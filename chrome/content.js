...
chrome.storage.local.get(["threadsOnly", "darkMode"]).then((result) => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  nerdstarCSS.textContent = `
    .tftv-dark .star-0 { background-image: url("${chrome.runtime.getURL("nerdstars/nerdstar-4.gif")}") !important; }
    .tftv-dark .star-1 { background-image: url("${chrome.runtime.getURL("nerdstars/nerdstar-3.gif")}") !important; }
    .tftv-dark .star-2 { background-image: url("${chrome.runtime.getURL("nerdstars/nerdstar-2.gif")}") !important; }
    .tftv-dark .star-3 { background-image: url("${chrome.runtime.getURL("nerdstars/nerdstar-1.gif")}") !important; }
  `;
  ...
  chrome.storage.local.get(["threadsOnly", "darkMode"]).then((result) => {
    ...
    document.addEventListener("click", (e) => {
      ...
      chrome.storage.local.set({ darkMode: willBeActive });
    });
    ...
    document.addEventListener("click", (e) => {
      ...
      chrome.storage.local.set({ threadsOnly: willBeActive });
